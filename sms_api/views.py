...
class CourseListCreate(CreateModelMixin,ListModelMixin , GenericAPIView):
...
class CourseRUD(RetrieveModelMixin,UpdateModelMixin, DestroyModelMixin, GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
    queryset =Course.objects.all()
    serializer_class = CourseSerializer
...
class StudentListCreate(CreateModelMixin,ListModelMixin , GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
...
class SubjectListCreate(CreateModelMixin,ListModelMixin , GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
...
class SubjectRUD(RetrieveModelMixin,UpdateModelMixin, DestroyModelMixin, GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
    queryset =Subject.objects.all()
    serializer_class = SubjectSerializer
...
class CourseOfStudentListCreate(CreateModelMixin,ListModelMixin , GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
    queryset =Course_of_student.objects.all()
    serializer_class = Course_of_studentSerializer
...
class CourseOfStudentRUD(RetrieveModelMixin,UpdateModelMixin, DestroyModelMixin, GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
    queryset =Course_of_student.objects.all()
    serializer_class = Course_of_studentSerializer
...
class TeacherSalaryListCreate(CreateModelMixin,ListModelMixin , GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
    queryset =Teacher_salary.objects.all()
    serializer_class = Teacher_salarySerializer
...
class TeacherSalaryRUD(RetrieveModelMixin,UpdateModelMixin, DestroyModelMixin, GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
    queryset =Teacher_salary.objects.all()
    serializer_class = Teacher_salarySerializer
...
class TeacherSalaryAllowanceListCreate(CreateModelMixin,ListModelMixin , GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
    queryset =Teacher_salary_allowance.objects.all()
    serializer_class = Teacher_salary_allowanceSerializer
...
class TeacherSalaryAllowanceRUD(RetrieveModelMixin,UpdateModelMixin, DestroyModelMixin, GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
    queryset =Teacher_salary_allowance.objects.all()
    serializer_class = Teacher_salary_allowanceSerializer
...
class TeacherListCreate(CreateModelMixin,ListModelMixin , GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
...
class TeacherRUD(RetrieveModelMixin,UpdateModelMixin, DestroyModelMixin, GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
    queryset =Teacher.objects.all()
    serializer_class = TeacherSerializer
...
class SubjectOfTeacherListCreate(CreateModelMixin,ListModelMixin , GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
    queryset =Subject_of_teacher.objects.all()
    serializer_class = Subject_of_teacherSerializer
...
class SubjectOfTeacherRUD(RetrieveModelMixin,UpdateModelMixin, DestroyModelMixin, GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
    queryset =Subject_of_teacher.objects.all()
    serializer_class = Subject_of_teacherSerializer
...
class StudentFeeListCreate(CreateModelMixin,ListModelMixin , GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
    queryset =Student_fee.objects.all()
    serializer_class = Student_feeSerializer
...
class StudentFeeRUD(RetrieveModelMixin,UpdateModelMixin, DestroyModelMixin, GenericAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
    queryset =Student_fee.objects.all()
    serializer_class = Student_feeSerializer
