...
from .views import UserRegisterView ,UserLoginView ,CourseApiView, CourseApiIdView, SubjectApiIdView, SubjectApiView, StudentApiIdView, StudentApiView, CourseOfStudentApiIdView, CourseOfStudentApiView, TeacherApiIdView, TeacherApiView,  TeacherSalaryApiIdView, TeacherSalaryApiView,TeacherSalaryAllowanceApiIdView, TeacherSalaryAllowanceApiView, SubjectOfTeacherApiIdView, SubjectOfTeacherApiView,StudentFeeApiIdView, StudentFeeApiView
